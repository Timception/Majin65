...
[0] = LAYOUT_all(
   ...
   RGB_HUD, KC_TAB,  KC_Q,    KC_W,    KC_E, KC_R, KC_T,   KC_Y, KC_U, KC_I,    KC_O,    KC_P,    KC_LBRC,  KC_RBRC,  KC_BSLS, KC_VOLU, 
   RGB_HUI, KC_CAPS, KC_A,    KC_S,    KC_D, KC_F, KC_G,   KC_H, KC_J, KC_K,    KC_L,    KC_SCLN, KC_QUOT,            KC_ENT,  KC_VOLD,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [0] = { ENCODER_CCW_CW(TO(3), TO(1)), ENCODER_CCW_CW(RGB_RMOD, RGB_MOD) },
    [1] = { ENCODER_CCW_CW(TO(0), TO(2)), ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [2] = { ENCODER_CCW_CW(TO(1), TO(3)), ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
    [3] = { ENCODER_CCW_CW(TO(2), TO(0)), ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
};
#endif